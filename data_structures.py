...
class ComponentType(Enum):
    ...
    LED_1_YELLOW = "LED_1 (Yellow)"
    LED_2_RED = "LED_2 (Red)"
    RESISTOR = "Resistor"
    LAMP = "Lamp"
    PHOTORESISTOR = "Photoresistor"
    U_1_BLUE_MUSIC_CIRCUIT = "U_1 blue music circuit"
    U_2_RED_ALARM_CIRCUIT = "U_2 red alarm circuit"
    U_3_GREEN_SPACE_WAR_CIRCUIT = "U_3 green space war circuit"
    SPEAKER = "Speaker"
    SLIDE_SWITCH = "Slide switch"
    PRESS_SWITCH = "Press switch"
    WHISTLE_CHIP = "Whistle chip"
